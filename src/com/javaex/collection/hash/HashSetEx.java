...
//	      HashSet<Integer> setB = (HashSet<Integer>)evens.clone();
	      ...
	      setB = (HashSet<Integer>)odds.clone(); //	짝수 집합
	      
	      System.out.println("집합A:" + setA);
	      System.out.println("집합B:" + setB);

	      setA.addAll(setB); 	//	집함 A 합집합 집합B
	   ...
	   private static void usingHashSetWithCustomer() {
		   ...
		   //	s3, s4가 이름도 같고 학번도 같으니 두 객체를 동등객체로 판별하도록 로직을 작성해야 한다.
		   hs.add(s1);
		   hs.add(s2);
		   hs.add(s3);
		   hs.add(s4);
