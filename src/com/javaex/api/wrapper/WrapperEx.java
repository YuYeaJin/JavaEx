...
public class WrapperEx {
	...
	public static void main(String[] args) {
		...
		// new Warpper는 jdk9부터 deprecated -> 가급적 빠른 수정 권장
		...
		//	자동박싱(Auto Boxing)
		Integer i3 = 10;	//	 => Integer i3 = Integer.valueOf(10); 와 같은 의미
		
		//	포장된 값의 비교
		Integer i4 = Integer.valueOf(2024);
		Integer i5 = Integer.valueOf(2024);
		
		System.out.println(i4 == i5);	//	참조 객체이기 때문에 주소 비교. 따라서 false, 주의해야 함.
